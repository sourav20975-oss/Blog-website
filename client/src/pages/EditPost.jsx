...
export default function EditPost() {
  ...
  if (error && !post) {
    return (
      <main className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <Link to="/" className="mt-4 inline-block text-orange-400 hover:underline">&larr; Back to Home</Link>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      <h1 className="text-2xl font-extrabold text-white sm:text-3xl">Edit Post</h1>
